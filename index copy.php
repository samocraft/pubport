    ...
    <nav class="navbar">
        <ul class="navbar-list">
            <li class="navbar-item">
                <a href="?page=about" class="navbar-link <?php echo ($_GET['page'] == 'about' || !isset($_GET['page'])) ? 'active' : ''; ?>">About</a>
            </li>
            <li class="navbar-item">
                <a href="?page=resume" class="navbar-link <?php echo ($_GET['page'] == 'resume') ? 'active' : ''; ?>">Resume</a>
            </li>
            <li class="navbar-item">
                <a href="?page=portfolio" class="navbar-link <?php echo ($_GET['page'] == 'portfolio') ? 'active' : ''; ?>">Portfolio</a>
            </li>
            <li class="navbar-item">
                <a href="?page=contact" class="navbar-link <?php echo ($_GET['page'] == 'contact') ? 'active' : ''; ?>">Contact</a>
            </li>
        </ul>
    </nav>
